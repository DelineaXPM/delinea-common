...
import (
	...
	"github.com/DelineaXPM/delinea-common/internal/e2etest"
)
...
func ssConfig(e map[string]string) Config {
	return Config{
		URL:      e["DELINEA_COMMON_TEST_SS_URL"],
		Username: e["DELINEA_COMMON_TEST_SS_USERNAME"],
		Password: e["DELINEA_COMMON_TEST_SS_PASSWORD"],
...
func platformConfig(e map[string]string) Config {
	return Config{
		URL:      e["DELINEA_COMMON_TEST_PLATFORM_URL"],
		Target:   api.TargetPlatform,
		Username: e["DELINEA_COMMON_TEST_PLATFORM_CLIENT_ID"],
		Password: e["DELINEA_COMMON_TEST_PLATFORM_CLIENT_SECRET"],
		Timeout:  30 * time.Second,
		Retries:  3,
	}
}
...
func TestE2ESecretServerByPath(t *testing.T) {
	e := requireEnv(t,
		"DELINEA_COMMON_TEST_SS_URL", "DELINEA_COMMON_TEST_SS_USERNAME", "DELINEA_COMMON_TEST_SS_PASSWORD",
		"DELINEA_COMMON_TEST_SS_SECRET_PATH", "DELINEA_COMMON_TEST_SS_SECRET_FIELD", "DELINEA_COMMON_TEST_SS_SECRET_VALUE")
	e2eCheck(t, ssConfig(e),
		"V="+e["DELINEA_COMMON_TEST_SS_SECRET_FIELD"]+"@"+e["DELINEA_COMMON_TEST_SS_SECRET_PATH"], e["DELINEA_COMMON_TEST_SS_SECRET_VALUE"])
}

func TestE2EPlatform(t *testing.T) {
	e := requireEnv(t,
		"DELINEA_COMMON_TEST_PLATFORM_URL", "DELINEA_COMMON_TEST_PLATFORM_CLIENT_ID", "DELINEA_COMMON_TEST_PLATFORM_CLIENT_SECRET",
		"DELINEA_COMMON_TEST_PLATFORM_SECRET_ID", "DELINEA_COMMON_TEST_PLATFORM_SECRET_FIELD", "DELINEA_COMMON_TEST_PLATFORM_SECRET_VALUE")
	e2eCheck(t, platformConfig(e),
		"V="+e["DELINEA_COMMON_TEST_PLATFORM_SECRET_FIELD"]+"#"+e["DELINEA_COMMON_TEST_PLATFORM_SECRET_ID"], e["DELINEA_COMMON_TEST_PLATFORM_SECRET_VALUE"])
}

func TestE2EPlatformByPath(t *testing.T) {
	e := requireEnv(t,
		"DELINEA_COMMON_TEST_PLATFORM_URL", "DELINEA_COMMON_TEST_PLATFORM_CLIENT_ID", "DELINEA_COMMON_TEST_PLATFORM_CLIENT_SECRET",
		"DELINEA_COMMON_TEST_PLATFORM_SECRET_PATH", "DELINEA_COMMON_TEST_PLATFORM_SECRET_FIELD", "DELINEA_COMMON_TEST_PLATFORM_SECRET_VALUE")
	e2eCheck(t, platformConfig(e),
		"V="+e["DELINEA_COMMON_TEST_PLATFORM_SECRET_FIELD"]+"@"+e["DELINEA_COMMON_TEST_PLATFORM_SECRET_PATH"], e["DELINEA_COMMON_TEST_PLATFORM_SECRET_VALUE"])
}
...
func TestE2ESecretServerAttachment(t *testing.T) {
	base := requireEnv(t, "DELINEA_COMMON_TEST_SS_URL", "DELINEA_COMMON_TEST_SS_USERNAME", "DELINEA_COMMON_TEST_SS_PASSWORD")
	f := e2etest.Require(t,
		"DELINEA_COMMON_TEST_SS_FILE_SECRET_ID", "DELINEA_COMMON_TEST_SS_FILE_SECRET_FIELD",
		"DELINEA_COMMON_TEST_SS_FILE_SHA256")
	e2eAttachment(t, ssConfig(base), f["DELINEA_COMMON_TEST_SS_FILE_SECRET_ID"],
		f["DELINEA_COMMON_TEST_SS_FILE_SECRET_FIELD"], f["DELINEA_COMMON_TEST_SS_FILE_SHA256"])
}

func TestE2EPlatformAttachment(t *testing.T) {
	base := requireEnv(t, "DELINEA_COMMON_TEST_PLATFORM_URL", "DELINEA_COMMON_TEST_PLATFORM_CLIENT_ID", "DELINEA_COMMON_TEST_PLATFORM_CLIENT_SECRET")
	f := e2etest.Require(t,
		"DELINEA_COMMON_TEST_PLATFORM_FILE_SECRET_ID", "DELINEA_COMMON_TEST_PLATFORM_FILE_SECRET_FIELD",
		"DELINEA_COMMON_TEST_PLATFORM_FILE_SHA256")
	e2eAttachment(t, platformConfig(base), f["DELINEA_COMMON_TEST_PLATFORM_FILE_SECRET_ID"],
		f["DELINEA_COMMON_TEST_PLATFORM_FILE_SECRET_FIELD"], f["DELINEA_COMMON_TEST_PLATFORM_FILE_SHA256"])
}
